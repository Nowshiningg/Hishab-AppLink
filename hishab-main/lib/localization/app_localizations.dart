...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'premiumFeatureCloudSync': 'Cloud sync is a premium feature. Subscribe to sync your expenses across devices!',
    ...
    'bn': {
      ...
      'premiumFeatureCloudSync': 'ক্লাউড সিঙ্ক একটি প্রিমিয়াম ফিচার। ডিভাইস জুড়ে আপনার খরচ সিঙ্ক করতে সাবস্ক্রাইব করুন!',
